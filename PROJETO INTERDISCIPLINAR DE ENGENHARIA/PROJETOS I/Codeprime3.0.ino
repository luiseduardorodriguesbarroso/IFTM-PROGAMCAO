/*----------------RELATORIO DO CÓDIGO----------------
*
* Obs:Codeprime2.0 só com alteração na função de ataque do robo que na hhora de atacar sai de 160RPM para 255RPM  que e o maximo que os motores conseguem...
*
*/
...
void atacar() {
  ...
  int velocidadeAtaque = 255; // Usa velocidade máxima para o ataque
  analogWrite(motorEsq_A, velocidadeAtaque);
  analogWrite(motorEsq_B, 0);
  analogWrite(motorDir_A, velocidadeAtaque);
  analogWrite(motorDir_B, 0);
}
